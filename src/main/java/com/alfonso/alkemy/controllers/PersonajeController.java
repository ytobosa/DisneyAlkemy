...
public class PersonajeController {
	...
	@ResponseStatus(HttpStatus.OK)
	public List<EntPersonajeDto> PersonajesPorNombre(@PathVariable String nombre) {
	...
	@ResponseStatus(HttpStatus.OK)
	public List<EntPersonajeDto> PersonajesPorEdad(@PathVariable int edad) {
	...
	@ResponseStatus(HttpStatus.OK)
	public List<EntPersonajeDto> PersonajesPorEdad(@PathVariable Long idMovie) {
